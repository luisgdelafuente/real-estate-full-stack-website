    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Column 1: About */}
          <div>
            <h3 className="text-xl font-semibold mb-4">InmobiliariaZaragoza</h3>
            <p className="text-gray-400 mb-4">
              Somos especialistas en el mercado inmobiliario de Zaragoza, ofreciendo un servicio personalizado y de calidad desde 2010.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Compra de inmuebles</li>
              <li className="text-gray-400">Venta de propiedades</li>
              <li className="text-gray-400">Alquiler de viviendas</li>
              <li className="text-gray-400">Tasaciones</li>
              <li className="text-gray-400">Asesoría legal inmobiliaria</li>
              <li className="text-gray-400">Gestión patrimonial</li>
              <li className="text-gray-400">Home staging</li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© {currentYear} InmobiliariaZaragoza. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
