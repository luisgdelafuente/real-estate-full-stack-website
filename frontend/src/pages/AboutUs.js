...
function AboutUs() {
  React.useEffect(() => {
    document.title = 'Quiénes Somos | Inmobiliaria Zaragoza';
  }, []);
    ...
    <Layout>
      ...
      <section className="py-16 px-6 sm:px-8 md:px-12 lg:px-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold text-[#0D0D0D] mb-6">Nuestra Historia</h2>
            <p className="text-gray-700 mb-4">
              Desde nuestra fundación en 2010, <span className="font-semibold text-[#252359]">InmobiliariaZaragoza</span> se ha convertido en un referente del sector inmobiliario en la capital aragonesa, ofreciendo un servicio personalizado y de calidad a todos nuestros clientes.
            </p>
            <p className="text-gray-700 mb-4">
      ...
      <section className="py-16 px-6 sm:px-8 md:px-12 lg:px-16 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#0D0D0D] mb-4">Nuestros Valores</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              <div className="w-16 h-16 bg-[#252359]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-[#252359]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="py-16 px-6 sm:px-8 md:px-12 lg:px-16 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-[#0D0D0D] mb-4">Nuestra Trayectoria</h2>
          <p className="text-gray-700 max-w-3xl mx-auto">
          ...
          <div className="space-y-12">
            {milestones.map((milestone, index) => (
              <div key={index} className={`relative flex flex-col md:flex-row ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                <div className="md:w-1/2 p-6 md:p-10">
                  <div className="bg-white p-6 rounded-lg shadow-sm md:mx-6">
                    <div className="flex items-center mb-4">
                      <span className="text-3xl font-bold text-[#252359]">{milestone.year}</span>
                      <div className="ml-4 h-[2px] flex-grow bg-[#252359]"></div>
                    </div>
                ...
                <div className="absolute left-0 md:left-1/2 top-10 md:top-[calc(50%-10px)] transform md:translate-x-[-50%] w-5 h-5 bg-[#252359] rounded-full z-10"></div>
      ...
      <section className="py-16 px-6 sm:px-8 md:px-12 lg:px-16 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#0D0D0D] mb-4">Nuestro Equipo</h2>
            <p className="text-gray-700 max-w-3xl mx-auto">
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[#252359] font-medium mb-3">{member.role}</p>
      ...
      <section className="py-16 px-6 sm:px-8 md:px-12 lg:px-16 bg-[#252359] text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <a href="/contacto" className="inline-block bg-white text-[#252359] hover:bg-gray-100 px-8 py-3 rounded-md font-medium">
            Envíanos tu CV
          </a>
        </div>
      </section>
