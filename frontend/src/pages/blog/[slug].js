...
export default function BlogPostPage() {
  ...
  return (
    <Layout>
      <Head>
        <title>{blogPostData.title} | Inmobiliaria Zaragoza</title>
        <meta name="description" content={blogPostData.excerpt} />
        {/* Open Graph */}
        <meta property="og:title" content={blogPostData.title} />
        <meta property="og:description" content={blogPostData.excerpt} />
        <meta property="og:image" content={blogPostData.coverImage} />
        <meta property="og:type" content="article" />
        <meta property="article:published_time" content={blogPostData.publishedAt} />
        <meta property="article:author" content={blogPostData.author.name} />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="mb-8">
            <div className="flex items-center mb-4">
              {blogPostData.categories.map((category, index) => (
                <Link key={index} href={`/blog/categoria/${category.toLowerCase()}`} className="bg-primary/10 text-primary text-sm font-medium px-3 py-1 rounded mr-2 hover:bg-primary/20">
                  {category}
                </Link>
              ))}
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="font-medium text-dark">{blogPostData.author.name}</p>
          ...
          <div className="mt-12 flex flex-wrap justify-between items-center py-6 border-t border-b border-gray-200">
            <div className="flex flex-wrap items-center mb-4 md:mb-0">
              ...
              {blogPostData.categories.map((category, index) => (
                <Link key={index} href={`/blog/categoria/${category.toLowerCase()}`} className="bg-gray-100 text-gray-800 text-sm font-medium px-3 py-1 rounded mr-2 hover:bg-gray-200">
                  {category}
                </Link>
              ))}
            </div>
          ...
          <div className="mt-12 bg-gray-50 p-6 rounded-lg">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-xl font-semibold text-dark mb-1">Sobre {blogPostData.author.name}</h3>
                <p className="text-primary font-medium mb-2">{blogPostData.author.position}</p>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-bold text-dark mb-8">Artículos relacionados</h2>
