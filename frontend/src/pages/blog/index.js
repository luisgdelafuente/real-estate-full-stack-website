...
export default function BlogPage() {
  return (
    <Layout>
      <Head>
        <title>Blog Inmobiliario | Inmobiliaria Zaragoza</title>
        <meta name="description" content="Artículos, guías y consejos sobre el mercado inmobiliario en Zaragoza. Todo lo que necesitas saber sobre compra, venta y alquiler de propiedades." />
      </Head>
      ...
      <section className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Link href="/blog" className="inline-block bg-primary text-white px-3 py-1 rounded-md text-sm">
              Todas
            </Link>
          ...
          <div className="flex flex-col justify-center">
            <div className="flex items-center mb-3">
              {blogPosts[0].categories.map((category, index) => (
                <span key={index} className="bg-primary/10 text-primary text-xs font-medium px-2 py-1 rounded mr-2">
                  {category}
                </span>
              ))}
            </div>
            ...
            <Link href={`/blog/${blogPosts[0].slug}`} className="inline-block bg-primary hover:bg-primary-dark text-white font-medium py-2 px-4 rounded-md w-fit">
              Leer artículo
            </Link>
          </div>
        </div>
      ...
      {/* Blog Posts Grid */}
      <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <h2 className="text-2xl font-bold text-dark mb-8">Artículos recientes</h2>
            ...
            <article key={post.id} className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/blog/${post.slug}`} className="text-primary hover:text-primary-dark font-medium text-sm">
                    Leer más →
                  </Link>
                </div>
              </div>
        ...
        <div className="mt-12 flex justify-center">
          <button className="border border-primary text-primary hover:bg-primary hover:text-white font-medium py-2 px-4 rounded-md transition-colors">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-dark mb-3">Suscríbete a nuestra newsletter</h2>
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-grow rounded-md border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary"
              required
            />
            <button
              type="submit"
          ...
          <p className="text-xs text-gray-500 mt-4">
            Al suscribirte, aceptas nuestra <Link href="/politica-privacidad" className="text-primary hover:underline">política de privacidad</Link>.
