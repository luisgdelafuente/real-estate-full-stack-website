...
function PropertyList() {
  ...
  React.useEffect(() => {
    document.title = 'Propiedades en venta | Inmobiliaria Zaragoza';
  }, []);
      ...
      <section className="sticky top-16 z-20 bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              className="flex items-center space-x-2 text-[#252359] hover:text-[#1a1a40]"
          ...
          <div className={`grid grid-cols-1 md:grid-cols-4 gap-4 pt-4 ${filterOpen ? 'block' : 'hidden'}`}>
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-[#252359] focus:border-[#252359]"
              >
