...
import { HomeIcon, BuildingOffice2Icon, UserGroupIcon, BookOpenIcon } from '@heroicons/react/24/outline';
...
function Home() {
  React.useEffect(() => {
    document.title = 'Inmobiliaria Zaragoza | Tu hogar ideal en la capital aragonesa';
  }, []);
    ...
    <Layout>
      ...
      <section className="relative h-[80vh] w-full">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-6 sm:px-12 md:px-16 lg:max-w-3xl xl:max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/propiedades" className="bg-white text-[#252359] hover:bg-gray-100 px-6 py-3 rounded-md font-medium text-center">
              Ver propiedades
            </Link>
            <Link to="/contacto" className="bg-[#2D3773] hover:bg-[#232a58] text-white px-6 py-3 rounded-md font-medium text-center">
      ...
      <section className="py-16 px-6 sm:px-8 md:px-12 lg:px-16 max-w-7xl mx-auto">
        <div className="mb-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0D0D0D] mb-4">Propiedades destacadas</h2>
        ...
        <div className="mt-12 text-center">
          <Link to="/propiedades" className="inline-block bg-[#2D3773] hover:bg-[#232a58] text-white px-8 py-3 rounded-md font-medium">
      ...
      <section className="py-16 px-6 sm:px-8 md:px-12 lg:px-16 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0D0D0D] mb-4">¿Por qué elegirnos?</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              <div className="w-16 h-16 bg-[#252359]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <BuildingOffice2Icon className="w-8 h-8 text-[#252359]" />
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              <div className="w-16 h-16 bg-[#252359]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <UserGroupIcon className="w-8 h-8 text-[#252359]" />
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              <div className="w-16 h-16 bg-[#252359]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <HomeIcon className="w-8 h-8 text-[#252359]" />
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              <div className="w-16 h-16 bg-[#252359]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <BookOpenIcon className="w-8 h-8 text-[#252359]" />
              </div>
      ...
      <section className="py-16 px-6 sm:px-8 md:px-12 lg:px-16 max-w-7xl mx-auto">
        <div className="mb-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0D0D0D] mb-4">Lo que dicen nuestros clientes</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div className="font-medium">
              <p className="text-[#0D0D0D]">Carlos Martínez</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div className="font-medium">
              <p className="text-[#0D0D0D]">Ana y Miguel López</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div className="font-medium">
              <p className="text-[#0D0D0D]">Laura Sánchez</p>
      ...
      {/* CTA Section */}
      <section className="py-16 px-6 sm:px-8 md:px-12 lg:px-16 bg-[#252359] text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <Link to="/contacto" className="inline-block bg-white text-[#252359] hover:bg-gray-100 px-8 py-3 rounded-md font-medium">
